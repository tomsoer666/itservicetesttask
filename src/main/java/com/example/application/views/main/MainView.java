...
import com.example.application.views.testtask.TestTaskView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "itServiceTestTask", shortName = "itServiceTestTask",  enableInstallPrompt = false)
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "itServiceTestTask logo"));
        logoLayout.add(new H1("itServiceTestTask"));
    ...
    private Component[] createMenuItems() {
        RouterLink[] links = new RouterLink[] {
            new RouterLink("testcase", TestTaskView.class)
        };
